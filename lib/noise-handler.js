...
const { aesEncryptGCM, aesDecryptGCM, Curve, hkdf, sha256 } = require('./crypto-utils');
const { decodeBinaryNode } = require('./binary-node');
const { NOISE_WA_HEADER } = require('./constants');
...
module.exports = { makeNoiseHandler, NOISE_MODE };
